...
export const SelectBoardButton: React.FC<BoardSelectProps> = ({
  name,
  active = false,
  onClick,
}) => {
  return (
    <button
      className={
        active
          ? `group inline-flex items-center gap-x-3 font-bold bg-main-purple
              pl-6 pr-12 py-4 w-[15rem] lg:w-[17.25rem] rounded-br-full rounded-tr-full`
          : `group inline-flex items-center gap-x-3 font-bold
            hover:bg-main-purple/[0.1] active:bg-main-purple/[0.1] hover:dark:bg-white
            active:dark:bg-white pl-6 pr-12 py-4 w-[15rem] lg:w-[17.25rem] rounded-br-full rounded-tr-full`
      }
      onClick={onClick}
    >
      <svg
      ...
      >
        <path
          className={
            active
              ? 'fill-white'
              : 'group-hover:fill-main-purple group-active:fill-main-purple'
          }
          fillRule='evenodd'
          clipRule='evenodd'
      ...
      <p
        className={
          active
            ? 'text-m text-white text-ellipsis whitespace-nowrap overflow-hidden'
            : `text-m text-medium-grey group-hover:text-main-purple group-active:text-main-purple
