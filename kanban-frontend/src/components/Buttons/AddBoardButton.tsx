...
export const AddBoardButton = () => {
  ...
  return (
    <>
      {toggleModal ? <AddBoardModal toggleModal={setToggleModal} /> : null}
      <button
        className='group inline-flex items-center gap-x-3 text-main-purple
          hover:text-main-purple-hover font-bol pl-6 py-4'
      ...
      >
        ...
        >
          <path
            className='group-hover:fill-main-purple-hover'
            fillRule='evenodd'
            clipRule='evenodd'
        ...
        <p className='text-m font-bold'>+ Create New Board</p>
      </button>
    </>
  );
};
